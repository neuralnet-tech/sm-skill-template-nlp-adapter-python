...
def get_hello_response(): 
    cards, intent, annotations =  None, None, None
    response = f"Hello and welcome our honoured guests, Yang Amat Berhormat Datuk Seri Utama Haji Aminudin Bin Harun, the Menteri besar of Negeri Sembilan. I am Xiao Mei. We thank you for officiating the opening ceremony of our building. How may I assist you?"
    return response, cards, intent, annotations
